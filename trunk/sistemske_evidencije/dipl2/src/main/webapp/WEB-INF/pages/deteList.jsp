...
<display:table name="detes" class="table" requestURI="" id="deteList" export="true" pagesize="25">
    ...
    <display:column property="adrr" sortable="true" titleKey="dete.adrr"/>
    <display:column property="drde" sortable="true" titleKey="dete.drde"/>
    <display:column property="gradr" sortable="true" titleKey="dete.gradr"/>
    <display:column property="imede" sortable="true" titleKey="dete.imede"/>
    <display:column property="imer" sortable="true" titleKey="dete.imer"/>
    <display:column property="jmbde" sortable="true" titleKey="dete.jmbde"/>
    <display:column property="jmbr" sortable="true" titleKey="dete.jmbr"/>
    <display:column property="przde" sortable="true" titleKey="dete.przde"/>
    <display:column property="przr" sortable="true" titleKey="dete.przr"/>
    <display:column property="telr" sortable="true" titleKey="dete.telr"/>
    <display:column property="zipr" sortable="true" titleKey="dete.zipr"/>
