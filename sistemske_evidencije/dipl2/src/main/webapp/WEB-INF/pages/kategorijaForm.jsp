...
<s:form id="kategorijaForm" action="saveKategorija" method="post" validate="true">
    ...
    <s:textfield key="kategorija.nazk" required="true" maxlength="25" cssClass="text medium"/>
    <s:textfield key="kategorija.opisk" required="false" maxlength="30" cssClass="text medium"/>
