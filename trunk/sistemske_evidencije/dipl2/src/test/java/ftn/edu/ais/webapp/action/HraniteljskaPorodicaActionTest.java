...
public class HraniteljskaPorodicaActionTest extends BaseActionTestCase {
    ...
    protected void onSetUpBeforeTransaction() throws Exception {
        ...
        hraniteljskaPorodica.setAdrh("CxNrEjFsXsUuJyRgAvUsSgNnEbCdJyVhUtJaKzThVsOwXiXeZo");
        hraniteljskaPorodica.setGradh("CbGpOpFpKkAtYpRaXfMf");
        hraniteljskaPorodica.setImeh("WcEpOkXnFeGuDzEzCnKr");
        String tmpJmbh = ("" + Math.random()).substring(0, 12);
        hraniteljskaPorodica.setJmbh(tmpJmbh);
        hraniteljskaPorodica.setPrzh("YxDiUoSyAkOtToDgQxPn");
        hraniteljskaPorodica.setZiph("IqLfIuFrXs");
    ...
    public void testSave() throws Exception {
        ...
        hraniteljskaPorodica.setAdrh("DiYrMcNwYeHuPbKbAwJkGyAyPxLzXhAeZbKxNkYmTwYgYpCmYm");
        hraniteljskaPorodica.setGradh("MdBrZbQwPcLwKiVmMyQo");
        hraniteljskaPorodica.setImeh("XhOlTwIvIbHkMbVeQhDp");
        hraniteljskaPorodica.setJmbh("NkPzExZyHwWaY");
        hraniteljskaPorodica.setPrzh("CpJtCwMbDwItHmWqKhGy");
        hraniteljskaPorodica.setZiph("ByNsWaSdWq");
