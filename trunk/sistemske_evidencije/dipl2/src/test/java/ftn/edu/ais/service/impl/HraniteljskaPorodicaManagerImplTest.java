...
public class HraniteljskaPorodicaManagerImplTest extends BaseManagerMockTestCase {
    ...
    public void testSaveHraniteljskaPorodica() {
        ...
        hraniteljskaPorodica.setAdrh("IwBkVaVrEwFeDuTkBgViEjXcCjUmPbRiObPfJmBuBeZpRfAjFl");
        hraniteljskaPorodica.setGradh("QpVxVnPeRiNbGyGeJhKt");
        hraniteljskaPorodica.setImeh("KcMkPxJrXaSzMvWmJiLb");
        hraniteljskaPorodica.setJmbh("SwElSiZtNqFkJ");
        hraniteljskaPorodica.setPrzh("LyZiFsMxWbUzNnXeLrDk");
        hraniteljskaPorodica.setZiph("ViHhZdBmYp");
